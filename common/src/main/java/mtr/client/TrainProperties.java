...
public class TrainProperties {
	...
	public final float railSurfaceOffset;
	...
	public TrainProperties(String baseTrainType, Component name, String description, String wikipediaArticle, int color, float riderOffset, float riderOffsetDismounting, float railSurfaceOffset, float bogiePosition, boolean isJacobsBogie, boolean hasGangwayConnection, TrainRendererBase renderer, TrainSoundBase sound) {
		...
		this.railSurfaceOffset = railSurfaceOffset;
